 ...
 */
    ...
    __pyx_t_12 = ((*((long *) ( /* dim=0 */ (__pyx_v_warmup2.data + __pyx_t_11 * __pyx_v_warmup2.strides[0]) ))) + __pyx_v_i);
    try {
      __pyx_v_samples.push_back((*((double *) ( /* dim=0 */ (__pyx_v_nv.data + __pyx_t_12 * __pyx_v_nv.strides[0]) ))));
    } catch(...) {
      __Pyx_CppExn2PyErr();
 ...
 */
  ...
  if (unlikely(!Py_OptimizeFlag)) {
    ...
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = __Pyx_PyFloat_EqObjC(__pyx_t_3, __pyx_float_neg_40_0, -40.0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 248, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
